...
>    1. 其中有一接触过android webview 调试的同学可能了解adb，如果你想使用adb命令可以使用IDE内置adb
...
- 注意一定先安装jdk配置IDE,如果你是安装配置了IDE,系统会自动为你安装jdk，此时你使用yarn android 是跑不起来的。
- 必须先卸载掉jdk 在安装文档重新安装jdk. 删除项目重新安装`npx react-native init AwesomeProject`，然后在执行`yarn andriod`才能正常跑起项目


>    <img src="https://cdn.nlark.com/yuque/0/2022/png/190178/1655262889834-008bb553-777d-472e-8678-6129bd07467e.png" style="width: 500px">y按个
>    <img src="https://cdn.nlark.com/yuque/0/2022/png/190178/1655262889834-008bb553-777d-472e-8678-6129bd07467e.png" style="width: 500px">
